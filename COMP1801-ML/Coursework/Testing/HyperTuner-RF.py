...
---------------------------------------------------
RandomForest Hyperparameter Tuning Pipeline with Command Line Arguments
"""
...
class RandomForestTuner:
    ...
    def create_pipeline(self, df, target='Lifespan'):
        ...
        self.model = Pipeline([
            ...
            ('regressor', RandomForestRegressor(random_state=self.random_state, n_jobs=-1))
        ])
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description='RandomForest Hyperparameter Tuning Pipeline',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python HyperTuner-RF.py --method random --iterations 100
  python HyperTuner-RF.py --method grid
  python HyperTuner-RF.py --method random --iterations 50 --seed 123
        """
    )
...
def main():
    ...
    tuner = RandomForestTuner(random_state=args.seed)
